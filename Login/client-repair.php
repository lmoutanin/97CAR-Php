        ...
        <table class="formul1">
            ...
            <tbody>
                <?php foreach ($fts as $ft) {
                    ...
                    $facture = new Facture($id, $ft['Id_voiture'], $ft['date_facture'], $ft['marque'], $ft['modele'], $ft['cout'], $ft['quantite'], $ft['descriptions']);
                ?>
